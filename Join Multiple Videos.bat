...
title Video Merger - Join Multiple Videos with Custom Resolution

:: ---- FOLDERS ----
set "ROOT=%~dp0"
set "INPUT_FOLDER=%ROOT%join_videos"
set "OUTPUT_FOLDER=%ROOT%output"

:: Create folders if they don't exist
if not exist "%INPUT_FOLDER%" (
    md "%INPUT_FOLDER%"
    echo ℹ Created join_videos folder. Please put your videos there and run again.
    pause
    exit /b
)
...
if errorlevel 1 (
    echo ❌ No video files found in join_videos folder!
...
echo.
echo ====================================================================
echo 		Multiple Video Join- by Munna MasterMind
echo 			https://facebook.com/The.Munna
echo ====================================================================
echo Found !COUNT! video files in join_videos folder
echo -------------------------------------------
